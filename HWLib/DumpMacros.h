...
#define src() String::FilePosition(__FILE__,__LINE__,0,__FUNCTION__)
...
//#define dumpo if(Trace) _funcdump
//#define argdump(x) {if(Trace)(vardump(x)+"\n").print();}
//#define argxdump(x) {if(Trace)(varxdump(x)+"\n").print();}
//#define srcargdump(x) {if(Trace)(vardump(x)+"\n").fsrcprint();}
//#define srcargxdump(x) {if(Trace)(varxdump(x)+"\n").fsrcprint();}
//#define dumpreturn(x) {if(Trace) \
//    (String("\1-return ") + vardump(x) + "\n").print(); \
//    return; }
//
...
//
//#define fdump()           if(Trace) _funcdump(__FUNCTION__)
